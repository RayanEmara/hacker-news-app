...
struct MockData {
    ...
    static let newStories: [HNStory] = [
        ...
        HNStory(id: 106, title: "Why I switched from VS Code to Zed after 8 years", url: "https://zed.dev", domain: "zed.dev", score: 89, author: "editorhopper", timeAgo: "31m ago", commentsCount: 42, feed: .new),
